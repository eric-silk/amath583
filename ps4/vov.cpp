...
int main(int argc, char* argv[]) {
  ...
  std::cout << "================================================================" << std::endl;
  std::cout << "  Row ordering " << std::endl;
  ...
  plt::named_loglog("Row", sizes, flops);

  std::cout << "================================================================" << std::endl;
  std::cout << "  Row ordering, ikj " << std::endl;
  std::cout << "N\ttrips\ttotal\tavg\tGflops" << std::endl;
  sizes.clear();
  flops.clear();
  for (size_t size = 16; size <= maxsize; size *= 2) {
  ...
  plt::named_loglog("Row, ikj", sizes, flops);
